...
/**
 * CUST-03 / FR-04: Denetim (audit) kaydi. ER: db.sql -> CUSTOMER_SERVICE_AUDIT_LOG
 * Musteri entity'lerinde (Customer, Address, Contact, Document, Consent) yapilan
 * her degisiklik icin bir satir olusturulur.
 */
@Entity
@Table(name = "customer_service_audit_log")
public class CustomerAuditLog {
    ...
    protected CustomerAuditLog() {
    }

    public CustomerAuditLog(UUID actorUserId, String action, String entityType, UUID entityId,
