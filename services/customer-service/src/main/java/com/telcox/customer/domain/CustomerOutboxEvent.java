...
@Entity
@Table(name = "customer_service_outbox_event")
public class CustomerOutboxEvent {
    ...
    protected CustomerOutboxEvent() {
    }

    public CustomerOutboxEvent(UUID aggregateId, String aggregateType, String eventType,
